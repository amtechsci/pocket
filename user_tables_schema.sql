...
CREATE INDEX idx_addresses_user_type ON user_addresses(user_id, address_type);

-- Employment lookup indexes
CREATE INDEX idx_employment_user_type ON user_employment(user_id, employment_type);

-- Bank account lookup indexes
CREATE INDEX idx_bank_accounts_user_primary ON user_bank_accounts(user_id, is_primary);
...
CREATE INDEX idx_verifications_user_type ON user_verifications(user_id, verification_type);
