...
const schemaPath = path.join(__dirname, '../../user_tables_simple.sql');
...
console.log('\n📋 Last 200 characters:');
console.log(schema.substring(schema.length - 200));
...
const statements = allStatements
  ...
  .filter(stmt => {
    ...
    console.log(`Statement: "${stmt.substring(0, 30)}..." - Length: ${stmt.length}, HasContent: ${hasContent}, IsComment: ${isComment}`);
